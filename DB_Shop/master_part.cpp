...
void master_part::Search(QString key, int Type){
...
void master_part::load_search_data(int ID){
...
QString master_part::find_company(int id){
...
void master_part::on_radio_Name_clicked()
{
    Search(ui->txt_search->text(),0);
}

void master_part::on_redio_Category_clicked()
{
    Search(ui->txt_search->text(),1);
}

void master_part::on_txt_search_textChanged(const QString &arg1)
{
...
void master_part::on_tbl_search_clicked(const QModelIndex &index)
{
