...
void Master_signup::on_btn_verify_clicked()
{
    ...
    v_employee->SetPass(E_Code,M_Code);
    v_employee->exec();

    if(v_employee->get_status() == true){

        // Add a new user to software :

        // add user to accounts :
        if(add_to_accounts(3) == false){
...
void Master_signup::set_input_methods(){
...
bool Master_signup::check_inputs(){
...
bool Master_signup::Send_Email(QString Email,QString Name,QString Subject,QString Body){
...
bool Master_signup::add_to_accounts(int type){
...
bool Master_signup::is_valid_User(){
...
void Master_signup::on_btn_close_clicked()
{
    exit(0);
}

void Master_signup::on_btn_cansel_clicked()
{
    this->close();
}

void Master_signup::on_btn_load_clicked()
{
...
void Master_signup::on_btn_clear_clicked()
{
